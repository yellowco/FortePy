...
class RetrospectiveTransaction(object):
    ...
    def get_client_data(client):
        d = {'ecom_billto_online_email': client.email,
             ...
             'pg_billto_date_of_birth': client.birthdate.strftime("%d/%m/%Y"),
    ...
    def execute(self, operation={}):
        RetrospectiveTransaction.SOCKET.write_header()
        ...
        for key, value in operation.items():
            RetrospectiveTransaction.SOCKET.write(key, value)
        RetrospectiveTransaction.SOCKET.send()
        response = RetrospectiveTransaction.SOCKET.read()
